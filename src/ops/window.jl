...
_emit_early(::WindowOp{T, Data, CombineOp, ExtractOp, true}) where {T, Data, CombineOp, ExtractOp} = true
_emit_early(::WindowOp{T, Data, CombineOp, ExtractOp, false}) where {T, Data, CombineOp, ExtractOp} = false
